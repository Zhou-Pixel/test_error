...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1148559436;
...
fn wire__crate__api__profile__Database_open_impl(
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::profile::Database::open();
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__profile__Database_open_impl(port, ptr, rust_vec_len, data_len),
...
mod io {
    ...
    #[no_mangle]
    pub extern "C" fn frbgen_test_error_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDatabase(
    ...
    #[no_mangle]
    pub extern "C" fn frbgen_test_error_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDatabase(
        ptr: *const std::ffi::c_void,
    ) {
